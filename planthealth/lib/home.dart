...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> get_plants() async {
    ...
    var url = Uri.parse(
        'https://zlnhbt4ogh.execute-api.us-east-1.amazonaws.com/get_plants?user_id=$user_id');
        ...
        child: Stack(children: [
          ...
          Column(
            children: [
              ...
              Container(height: 400, child: getWidget()),
            ],
          ),
        ]),
      ),
    ...
    if (plant_data != null) {
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          String ideal_temp =
              plant_data[index]['ideal_data']['temperature_range'];
          String plant_temperature = null;
          if (plant_data[index]['data'].length != 0) {
            plant_temperature = plant_data[index]['data']['temperature'];
          }
          return get_card(plant_name, plant_nick_name, plant_temperature,
              ideal_temp, last_updated, index);
        },
      );
    } else {
  ...
  get_card(String plant_name, String plant_nick_name, String plant_temperature,
      String ideal_temp, String last_updated, int index) {
